...
import UIKit
class LocationViewController: UIViewController, AddReviewDelegate {
    ...
    func setUpStatistics(averageN: Double, averageM: Double, averageS: Double) {
        ...
        websiteView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant:235).isActive = true
        ...
        directionView.leadingAnchor.constraint(equalTo: websiteView.trailingAnchor, constant: 10).isActive = true
        directionView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant:235).isActive = true
        ...
        phoneView.leadingAnchor.constraint(equalTo: directionView.trailingAnchor, constant: 10).isActive = true
        phoneView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant:235).isActive = true
